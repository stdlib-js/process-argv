...
```javascript
import ARGV from 'https://cdn.jsdelivr.net/gh/stdlib-js/process-argv@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/process-argv/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/process-argv/actions/workflows/test.yml?query=branch:v0.2.1
